...
#The Fibonacci function should take in a number and return a list containing aFibonacci sequence of that many numbers

import logging
#logging.basicConfig(level=logging.DEBUG)

#def fibonacci(number): #this is the funvtion- currently empty
    #return []
...
# the remainder of the program is errors reporting
